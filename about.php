...
<div class="postbox" style="display: block;width:670px;float:left;margin:10px;">
	...
	<div class="inside">
		<a href="http://wordpress.org/support/plugin/<?php echo BAWMRP_SLUG; ?>" class="button-secondary button-large">Need help? Use Support Forum</a>
		<a href="http://wordpress.org/extend/plugins/<?php echo BAWMRP_SLUG; ?>" class="button-secondary" button-large>Please rate the plugin!</a>
		<a href="http://wordpress.org/support/view/plugin-reviews/<?php echo BAWMRP_SLUG; ?>" class="button-secondary button-large">Write a cool review too!</a>
